...
namespace AspNetCore.ReportingServices.Rendering.ExcelOpenXmlRenderer.Parser.spreadsheetml.x2006.main
{
	internal class CT_DefinedNames : OoxmlComplexType
	{
		...
		public List<CT_DefinedName> DefinedName
		{
			get
			{
				return this._definedName;
			}
			set
			{
				this._definedName = value;
			}
		}

		public static string DefinedNameElementName
		{
			get
			{
				return "definedName";
		...
		{
			this._definedName = new List<CT_DefinedName>();
		}
		...
		{
			this.Write_definedName(s, depth, namespaces);
		}

		public void Write_definedName(TextWriter s, int depth, Dictionary<string, string> namespaces)
		{
			if (this._definedName != null)
			{
				foreach (CT_DefinedName item in this._definedName)
				{
					if (item != null)
					{
