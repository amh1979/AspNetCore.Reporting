...
namespace AspNetCore.Reporting.Chart.WebForms.Utilities
{
	internal static class ChartPaletteColors
	{
		...
		{
			ChartPaletteColors.colorsGrayScale = null;
			ChartPaletteColors.colorsDefault = new Color[16]
			{
				Color.Green,
				Color.Blue,
				Color.Purple,
			...
			ChartPaletteColors.colorsPastel = new Color[16]
			{
				Color.SkyBlue,
				Color.LimeGreen,
				Color.MediumOrchid,
			...
			ChartPaletteColors.colorsEarth = new Color[16]
			{
			...
			ChartPaletteColors.colorsSemiTransparent = new Color[16]
			{
			...
			ChartPaletteColors.colorsLight = new Color[10]
			{
				Color.Lavender,
				Color.LavenderBlush,
				Color.PeachPuff,
			...
			ChartPaletteColors.colorsExcel = new Color[16]
			{
			...
			ChartPaletteColors.colorsBerry = new Color[11]
			{
				Color.BlueViolet,
				Color.MediumOrchid,
				Color.RoyalBlue,
			...
			ChartPaletteColors.colorsChocolate = new Color[10]
			{
				Color.Sienna,
				Color.Chocolate,
				Color.DarkRed,
			...
			ChartPaletteColors.colorsFire = new Color[10]
			{
				Color.Gold,
				Color.Red,
				Color.DeepPink,
			...
			ChartPaletteColors.colorsSeaGreen = new Color[10]
			{
				Color.SeaGreen,
			...
			ChartPaletteColors.colorsDundas = new Color[15]
			{
			...
			ChartPaletteColors.colorsPacific = new Color[20]
			{
			...
			ChartPaletteColors.colorsPacificLight = new Color[10]
			{
				Color.FromArgb(74, 197, 187),
				Color.FromArgb(95, 107, 109),
				Color.FromArgb(251, 130, 129),
			...
			ChartPaletteColors.colorsPacificSemitransparent = new Color[20]
			{
			...
			ChartPaletteColors.colorsGrayScale = new Color[16];
			for (int i = 0; i < 16; i++)
			{
				int num = 200 - i * 11;
				ChartPaletteColors.colorsGrayScale[i] = Color.FromArgb(num, num, num);
			}
		}
		...
		public static Color[] GetPaletteColors(ChartColorPalette palette)
		{
			...
			case ChartColorPalette.Default:
				return ChartPaletteColors.colorsDefault;
			case ChartColorPalette.Grayscale:
				return ChartPaletteColors.colorsGrayScale;
			case ChartColorPalette.Excel:
				return ChartPaletteColors.colorsExcel;
			case ChartColorPalette.Pastel:
				return ChartPaletteColors.colorsPastel;
			case ChartColorPalette.Light:
				return ChartPaletteColors.colorsLight;
			case ChartColorPalette.EarthTones:
				return ChartPaletteColors.colorsEarth;
			case ChartColorPalette.Semitransparent:
				return ChartPaletteColors.colorsSemiTransparent;
			case ChartColorPalette.Berry:
				return ChartPaletteColors.colorsBerry;
			case ChartColorPalette.Chocolate:
				return ChartPaletteColors.colorsChocolate;
			case ChartColorPalette.Fire:
				return ChartPaletteColors.colorsFire;
			case ChartColorPalette.SeaGreen:
				return ChartPaletteColors.colorsSeaGreen;
			case ChartColorPalette.BrightPastel:
				return ChartPaletteColors.colorsDundas;
			case ChartColorPalette.Pacific:
				return ChartPaletteColors.colorsPacific;
			case ChartColorPalette.PacificLight:
				return ChartPaletteColors.colorsPacificLight;
			case ChartColorPalette.PacificSemiTransparent:
				return ChartPaletteColors.colorsPacificSemitransparent;
			default:
				return null;
			}
		}
