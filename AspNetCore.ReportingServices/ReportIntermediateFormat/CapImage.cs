...
namespace AspNetCore.ReportingServices.ReportIntermediateFormat
{
	...
	internal sealed class CapImage : BaseGaugeImage, IPersistable
	{
		...
		internal new static Declaration GetDeclaration()
		{
			...
			return new Declaration(AspNetCore.ReportingServices.ReportIntermediateFormat.Persistence.ObjectType.CapImage, AspNetCore.ReportingServices.ReportIntermediateFormat.Persistence.ObjectType.BaseGaugeImage, list);
		}
