...
{
	internal static class HeaderFooterConstants
	{
		...
		internal const string BOLD_STYLE_NAME = "Bold";

		internal const string ITALIC_STYLE_NAME = "Italic";

		internal const string DEFAULT_STYLE_NAME = "Regular";

		internal const string DEFAULT_FONT_NAME = "-";
	}
}
