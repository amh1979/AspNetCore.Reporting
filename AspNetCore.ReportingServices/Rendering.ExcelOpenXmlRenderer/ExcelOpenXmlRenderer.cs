...
namespace AspNetCore.ReportingServices.Rendering.ExcelOpenXmlRenderer
{
	...
	internal class ExcelOpenXmlRenderer : AspNetCore.ReportingServices.Rendering.ExcelRenderer.ExcelRenderer
	{
		public override string LocalizedName
		{
			get
			{
				return ExcelRenderRes.ExcelOoxmlLocalizedName;
			}
		}

		protected override Stream CreateFinalOutputStream(string name, CreateAndRegisterStream createAndRegisterStream)
		{
			return createAndRegisterStream(name, "xlsx", null, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", false, StreamOper.CreateAndRegister);
		}
