...
namespace AspNetCore.Reporting.Map.WebForms
{
	internal class XmlFormatSerializer : SerializerBase
	{
			...
			if (objectToSerialize != null)
			{
				...
				else
				{
					...
					if (properties != null)
					{
						...
						{
							if ((!flag || !(propertyInfo.Name == "Name")) && !base.IsMapBaseProperty(objectToSerialize, parent, propertyInfo))
							{
								...
								else if (propertyInfo.CanRead && propertyInfo.CanWrite && !(propertyInfo.Name == "Item") && !(propertyInfo.Name == "Tag"))
								{
		...
		{
			this.Deserialize(objectToDeserialize, (object)stream);
		}

		public void Deserialize(object objectToDeserialize, XmlReader xmlReader)
		{
			this.Deserialize(objectToDeserialize, (object)xmlReader);
		}

		public void Deserialize(object objectToDeserialize, TextReader textReader)
		{
			this.Deserialize(objectToDeserialize, (object)textReader);
		}

		public void Deserialize(object objectToDeserialize, string fileName)
		{
			this.Deserialize(objectToDeserialize, (object)fileName);
		}
